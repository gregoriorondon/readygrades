...
<html lang="es">
    ...
    <div id="menu">
        <div class="flex h-screen menu-admin-dashboard">
            <!-- sidebar -->
            <div class="menu-hiden menu-admin-dashboard hidden lg:flex flex-col w-64">
            ...
            <!-- sidebar Movil -->
            <div class="sidebar-overlay fixed inset-0 z-[4] bg-black opacity-0 transition-opacity duration-300 pointer-events-none lg:hidden"></div>
            <div class="menu-admin-dashboard sidebar-movil z-[5] -translate-x-96 flex lg:hidden flex-col w-64 fixed z-[3] h-screen">
                <div class="flex items-center justify-center h-16">
                    @can('admins')
                        <span class="font-bold font-inter uppercase"><i class="fa-solid fa-user-tie"></i>Administrador</span>
                    @endcan
            ...
            <!-- Main content -->
            <div class="flex flex-col flex-1 overflow-y-auto lg:rounded-l-xl main-content redondeado">
                <div class="flex items-center justify-between h-16 border-b border-gray-200" @style('padding: 16px 0px 16px 0px')>
                    <div class="hidden lg:flex items-center px-4 space-x-7">
                    ...
                    <div class="lg:hidden flex items-center px-4 space-x-7">
