...
<div class="menu-float">
    <nav class="menu-float2">
        ...
        <a href="/login-profesor" class="{{ request()->is('login-profesor') ? 'underline underline-offset-8 decoration-4' : 'no-underline' }}"><i class="fa-solid fa-person-chalkboard"></i>Profesor</a>
    </nav>
</div>
...
<div class="movile-menu-open-open">
    ...
    <nav class="movile-menu-open-nav">
        ...
        <a href="/login-profesor"><i class="fa-solid fa-person-chalkboard"></i>Profesor</a>
    </nav>
</div>
