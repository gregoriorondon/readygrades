<form method="POST" action="{{ route('registro.profesor')}}">
    @csrf
    <div class="space-y-12 p-[21px]">
        <div class="border-gray-900/10 pb-12">
            <p class="mt-7 text-xl font-inter text-gray-400">Rellene todas las casillas para registrar al nuevo docente</p>
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        <div class="mt-2">
                            ...
                            <x-input-form type="text" name="primer-name" id="first-name" :value="old('primer-name')"
                                placeholder="Primer Nombre (Obligatorio)" required autocomplete="off" />
                            <x-input-form type="text" name="segundo-name" id="first-name" :value="old('segundo-name')"
                    ...
                    <div class="sm:col-span-3">
                        <div class="mt-2">
                            ...
                            <x-input-form type="text" name="primer-apellido" id="last-name" :value="old('primer-apellido')"
                                placeholder="Primer Apellido (Obligatorio)" required autocomplete="off" />
                            <x-input-form type="text" name="segundo-apellido" id="last-name" :value="old('segundo-apellido')"
                    ...
                    <div class="sm:col-span-2">
                        <div class="mt-2">
                            <x-label class="after:content-['*'] after:text-red-400">Cedula de Identidad</x-label>
                            <x-input-form class="sm:max-w-full" type="number" name="cedula" id="cedula"
                                :value="old('cedula')" placeholder="Número de Cedula" required autocomplete="off" />
                    ...
                    <div class="sm:col-span-2 sm:col-start-1">
                        <div class="mt-2">
                            <x-label class="after:content-['*'] after:text-red-400">Correo / Email</x-label>
                            <x-input-form type="email" name="email" id="email" :value="old('email')"
                                placeholder="Correo Electrónico del Administrador" required autocomplete="off" />
                    ...
                    <div class="sm:col-span-2">
                        <div class="mt-2">
                            <x-label class="after:content-['*'] after:text-red-400">Contraseña</x-label>
                            <x-input-form type="password" name="password" id="password"
                                placeholder="Contrasña Temporal para Iniciar Sesión" required autocomplete="off" />
                        </div>
                    </div>

                    <div class="sm:col-span-2">
                        <div class="mt-2">
                            <x-label class="after:content-['*'] after:text-red-400">Confirmar Contraseña</x-label>
                    ...
                    <div class="gap-x-6 gap-y-8 sm:grid-cols-6 divcarreratramonucleo">
                        <div class="carreratramonucleo">
                            <div class="mt-2">
                                ...
                                <x-select-form class="sm:max-w-full" name="cargo_id" id="cargo_id">
                            ...
                            <div class="mt-2">
                                ...
                                <x-select-form class="sm:max-w-full" name="estudio_id">
                                    @foreach ($estudio as $estudios)
                                        <option value="{{ $estudios->id }}">{{ strtoupper($estudios->estudio) }} -
                                            ({{ strtoupper($estudios->abrev) }})</option>
                                    @endforeach
                                </x-select-form>
