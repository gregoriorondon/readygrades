      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        <div class="sm:col-span-3">
          ...
          <x-label>Nombre Completo</x-label>
            <x-input-form type="text" name="primer_name" id="first-name" placeholder="Primer Nombre (Obligatorio)" :value="old('primer_name')" required autocomplete="off" />
            <x-input-form type="text" name="segundo_name" id="first-name" placeholder="Segundo Nombre" :value="old('segundo_name')" autocomplete="off" />
          </div>
        </div>
        ...
        <div class="sm:col-span-3">
          ...
          <x-label>Apellido Completo</x-label>
            <x-input-form type="text" name="primer_apellido" id="last-name" placeholder="Primer Apellido (Obligatorio)" :value="old('primer_apellido')" required autocomplete="off"  />
            <x-input-form type="text" name="segundo_apellido" id="last-name" placeholder="Segundo Apellido" :value="old('segundo_apellido')" autocomplete="off" />
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <x-label class="after:content-['*'] after:text-red-400">Cédula de Identidad</x-label>
            <x-input-form class="sm:max-w-full" type="number" name="cedula" id="cedula" placeholder="Número de Cedula del Estudiante" :value="old('cedula')" required autocomplete="off"  />
        ...
        <div class="sm:col-span-2 sm:col-start-1">
          ...
          <x-label>Correo / Email</x-label>
            <x-input-form type="email" name="email" id="email" placeholder="Dirección de Correo Electrónico del Estudiante" :value="old('email')"  autocomplete="off" />
          </div>
        </div>
        ...
        <div class="sm:col-span-1">
          ...
          <x-label>Teléfono</x-label>
            <x-input-form type="tel" name="telefono" id="telefono" placeholder="Teléfono del Estudiante" :value="old('telefono')"  autocomplete="off" />
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <x-label class="after:content-['*'] after:text-red-400">Dirección</x-label>
            <x-input-form type="text" name="direccion" id="direccion" placeholder="Dirección del Estudiante" :value="old('direccion')" required  autocomplete="off" />
          </div>
        </div>
        ...
        <div class="sm:col-span-1">
          ...
          <x-label class="after:content-['*'] after:text-red-400">Ciudad</x-label>
            <x-input-form type="text" name="city" id="city" placeholder="Ciudad o Pueblo del Estudiante" :value="old('city')" required  autocomplete="off" />
          </div>
        </div>
