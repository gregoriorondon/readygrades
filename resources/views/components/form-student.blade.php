      ...
      <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div class="sm:col-span-2">
          ...
          <x-label>Cedula de Identidad</x-label>
            <x-input-form class="sm:max-w-full" type="number" name="cedula" id="cedula" placeholder="Número de Cedula del Estudiante" />
          </div>
        </div>
        ...
        <div class="sm:col-span-2 sm:col-start-1">
          ...
          <x-label>Correo / Email</x-label>
            <x-input-form type="email" name="email" id="email" placeholder="Dirección de Correo Electrónico del Estudiante" />
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <x-label>Dirección</x-label>
            <x-input-form type="text" name="direccion" id="direccion" placeholder="Dirección del Estudiante" />
          </div>
        </div>
        ...
        <div class="sm:col-span-2">
          ...
          <x-label>Ciudad</x-label>
            <x-input-form type="text" name="city" id="city" placeholder="Ciudad o Pueblo del Estudiante" />
          </div>
        </div>
