...
<form class="flex items-center max-w-lg mx-auto mb-7" method="POST" action="/estudiantes-panel-administrativo/search">
    ...
    <div class="relative w-full">
        ...
        <x-input type="text" name="search" class="block w-full p-3 text-sm border border-gray-300 rounded-lg bg-gray-50/10 ps-32" placeholder="{{ ucwords('escribe para buscar') }}" required autocomplete="off" value="{{ $search }}" />
    </div>
