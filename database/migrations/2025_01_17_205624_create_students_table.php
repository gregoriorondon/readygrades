...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('title_student_temporal', function (Blueprint $table) {
            $table->id()->unique();
            $table->string('titulo')->unique();
            $table->timestamps();
        });
        DB::table('title_student_temporal')->insert([
            'id'=>1,
            'titulo'=>'Bachiller',
            'created_at'=> now(),
            'updated_at'=> now(),
        ...
        Schema::create('students_socio_economico', function (Blueprint $table) {
            $table->id()->unique();
            $table->string('socioeconomico')->unique();
            $table->timestamps();
        });
        DB::table('students_socio_economico')->insert([
            'id'=>1,
            'socioeconomico'=>'Alta',
            'created_at'=> now(),
            'updated_at'=> now(),
        ...
        Schema::create('nucleo_carrera', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('nucleo_id');
            $table->foreign('nucleo_id')->references('id')->on('nucleos')->cascadeOnUpdate();
        ...
        Schema::create('students_data', function (Blueprint $table) {
            ...
            $table->string('nacimiento_city')->nullable();
            $table->string('civil');
            $table->string('email');
            ...
            $table->string('city');
            $table->string('consejo')->nullable();
            $table->string('comuna')->nullable();
            $table->string('discapacidad')->nullable();
            $table->string('disciplina')->nullable();
            $table->unsignedBigInteger('title_student_temporal_id')->nullable();
            $table->foreign('title_student_temporal_id')->references('id')->on('title_student_temporal')->cascadeOnUpdate()->nullable();
            $table->string('mencion')->nullable();
            $table->string('institucion')->nullable();
            $table->string('cityinstitucion')->nullable();
            $table->date('fecha_grado')->nullable();
            $table->integer('promedio')->nullable();
            $table->unsignedBigInteger('students_socio_economico_id')->nullable();
            $table->foreign('students_socio_economico_id')->references('id')->on('students_socio_economico')->cascadeOnUpdate()->nullable();
            $table->string('trabaja')->nullable();
            $table->timestamps();
        });
        Schema::create('students_codigo_nucleo', function (Blueprint $table) {
            $table->id()->unique();
    ...
    public function down(): void
    {
        ...
        Schema::dropIfExists('students_codigo_nucleo');
